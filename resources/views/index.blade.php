...
@section('content')
    ...
    <!-- Hero Section -->
    <section class="relative min-h-screen flex items-center bg-[url('{{ asset('image/PSU-BG.png') }}')] bg-cover bg-center bg-no-repeat font-[Poppins]">
      <!-- Dark Overlay -->
      ...
      <div class="relative z-10 container mx-auto px-6 sm:px-10 flex flex-col md:flex-row items-center max-w-[1400px]">
        ...
        <div class="md:w-1/2 text-center md:text-left mb-12 md:mb-0">
          <h1 class="text-3xl sm:text-4xl md:text-5xl font-bold text-black mb-6 leading-tight">
          ...
          <div class="flex flex-col sm:flex-row gap-4 justify-center md:justify-start">
            <!-- Login Button -->
            <a href="{{ route('login') }}"
              class="bg-[#F15B24] text-white px-5 py-2.5 rounded-md font-bold hover:bg-[#FF9B45] flex items-center justify-center gap-2 transition">
              <img src="{{asset('image/icon/login1.png')}}" alt="Login Icon" class="w-8 h-8 sm:w-9 sm:h-9">
              Log In with Corporate Email
            </a>

            <!-- Guest Button -->
            <a href="{{ route('announcement') }}"
              class="bg-white border-2 border-[#D5451B] text-[#F15B24] px-5 py-2.5 rounded-md font-bold hover:bg-[#cbbab6] flex items-center justify-center gap-2 transition">
    ...
    <section class="container mx-auto px-4 sm:px-6 py-16 max-w-[1400px]">
      ...
      <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8 text-center">
        ...
        <div class="bg-white p-6 rounded-lg shadow-md hover:shadow-lg transition">
          ...
          <h3 class="text-lg sm:text-xl font-semibold mb-2 text-black">Verified Updates</h3>
          <p class="text-sm sm:text-base text-black">All info is officially reviewed before posting. No fake or misleading updates.</p>
        </div>
        ...
        <div class="bg-white p-6 rounded-lg shadow-md hover:shadow-lg transition">
          ...
          <h3 class="text-lg sm:text-xl font-semibold mb-2 text-black">Centralized Portal</h3>
          <p class="text-sm sm:text-base text-black">Enrollment, USG, events — everything in one place. Goodbye scattered pages!</p>
        </div>
        ...
        <div class="bg-white p-6 rounded-lg shadow-md hover:shadow-lg transition">
          ...
          <h3 class="text-lg sm:text-xl font-semibold mb-2 text-black">Student Access</h3>
          <p class="text-sm sm:text-base text-black">Login securely using your PSU student corporate email. No need to create a new account.</p>
        </div>
        ...
        <div class="bg-white p-6 rounded-lg shadow-md hover:shadow-lg transition">
          ...
          <h3 class="text-lg sm:text-xl font-semibold mb-2 text-black">Guest Mode</h3>
          <p class="text-sm sm:text-base text-black">Visitors can still view public info without needing an account.</p>
        </div>
    ...
    <section class="bg-white py-16">
      <div class="container mx-auto px-4 sm:px-6 text-center max-w-[1400px]">
        <h2 class="text-2xl sm:text-3xl font-bold text-black mb-4">
          What is PSU-Guide?
        </h2>
        <p class="text-black text-sm sm:text-base max-w-2xl mx-auto mb-6">
